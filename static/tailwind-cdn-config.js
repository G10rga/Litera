/* Development-only: feeds the Tailwind CDN the same theme as tailwind.config.js.
   Once `npm run build:css` has been run, base.html links static/dist/app.css
   instead and this file is not loaded. Keep the two in sync. */
